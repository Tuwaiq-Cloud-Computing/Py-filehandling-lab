...
file_path = os.path.expanduser("~/Desktop/string.txt")
...
part_1_file_path = os.path.expanduser("~/Desktop/part_1.txt")
part_2_file_path = os.path.expanduser("~/Desktop/part_2.txt")
